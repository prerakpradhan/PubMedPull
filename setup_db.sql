...
create table if not exists article_references(refid varchar(64),aid varchar(64),title varchar(500),authors_list varchar(1000),pmid varchar(10),primary key(refid),foreign key (aid) references article_meta(aid));
