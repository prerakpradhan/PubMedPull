...
create table if not exists article_meta(aid varchar(64), accession varchar(10),pmcid varchar(10),pmc_uid varchar(10),publisher_id varchar(50),pmid varchar(10),doi varchar(100),title_paper varchar(500),journal_id varchar(60),journal_title varchar(500),date_of_pub varchar(20),abstract longtext,authors varchar(5000),primary key (aid)) character set utf8 collate utf8_general_ci;
